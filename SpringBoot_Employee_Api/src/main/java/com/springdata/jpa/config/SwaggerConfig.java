...
import springfox.documentation.swagger2.annotations.EnableSwagger2;
		...
		@EnableSwagger2
		@ComponentScan(basePackages="com.springdata.jpa.restcontroller")
		@Configuration
		public class SwaggerConfig {
			
			private static final String SWAGGER_API_VERSION = "1.0";	
			private static final String LICENSE_TEXT= "Licenses";	
			private static final String title = "Employee Rest API";	
			private static final String description = "Restfull api for Employee and Projects";	
